 ...
 * 
 * This file provides utilities for extracting and refreshing narrative context
 * from various game state sources. It centralizes context extraction logic to
 * ensure consistent and up-to-date context for decision generation and AI prompts.
 */
