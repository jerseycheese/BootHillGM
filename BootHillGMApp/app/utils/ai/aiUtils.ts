export function generateNarrativeSummary(journal: string[]): string {
  // Logic for generating narrative summary
  return journal.join('\n');
}

export function determineIfWeapon(itemName: string): boolean {
