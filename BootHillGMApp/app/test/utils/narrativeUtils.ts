// BootHillGMApp/app/test/utils/narrativeUtils.ts (Reordered)
import { DecisionImportance, NarrativeState } from '../../types/narrative.types';
  ...
  return {
    ...
    narrative: {
      ...
      narrativeContext: {
        ...
        pendingDecisions: [],
        decisionHistory: [],
        storyPoints: getMockStoryPoints(), // Now defined above
        impactState: {
